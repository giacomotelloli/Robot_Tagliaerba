;; instance3_classic.pddl (Difficile)
(define (problem instance3_classic)
  ...
  (:init
    ...
    (battery-full robot1)
    (obstacle c23) (obstacle c35) (obstacle c54)
    ...
    (has-grass c21) (has-grass c22) (has-grass c24) (has-grass c25) (has-grass c26)
    (has-grass c31) (has-grass c32) (has-grass c33) (has-grass c34) (has-grass c36)
    (has-grass c41) (has-grass c42) (has-grass c43) (has-grass c44) (has-grass c45) (has-grass c46)
    (has-grass c51) (has-grass c52) (has-grass c53) (has-grass c55) (has-grass c56)
  ...
  (:goal
    (and
      ...
      (not (has-grass c21)) (not (has-grass c22)) (not (has-grass c24)) (not (has-grass c25)) (not (has-grass c26))
      (not (has-grass c31)) (not (has-grass c32)) (not (has-grass c33)) (not (has-grass c34)) (not (has-grass c36))
      (not (has-grass c41)) (not (has-grass c42)) (not (has-grass c43)) (not (has-grass c44)) (not (has-grass c45)) (not (has-grass c46))
      (not (has-grass c51)) (not (has-grass c52)) (not (has-grass c53)) (not (has-grass c55)) (not (has-grass c56))
