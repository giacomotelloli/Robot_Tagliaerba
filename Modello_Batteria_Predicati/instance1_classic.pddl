;; instance1_classic.pddl (Facile)
(define (problem instance1_classic)
  ...
  (:objects
   ...
   (:init
    (at robot1 c33)
    (charging-station c33)
    (battery-full robot1)
    (obstacle c25)
    ;; tutte le celle tranne l'ostacolo hanno erba
    (has-grass c11) (has-grass c12) (has-grass c13) (has-grass c14) (has-grass c15) (has-grass c16)
    (has-grass c21) (has-grass c22) (has-grass c23) (has-grass c24) (has-grass c26)
    (has-grass c31) (has-grass c32)  (has-grass c34) (has-grass c35) (has-grass c36)
  ...
  (:goal
    (and
      ...
      (not (has-grass c21)) (not (has-grass c22)) (not (has-grass c23)) (not (has-grass c24)) (not (has-grass c26))
      (not (has-grass c31)) (not (has-grass c32)) (not (has-grass c34)) (not (has-grass c35)) (not (has-grass c36))
